...
const About = () => {
  return (
    <Container className="mt-4">
      <h2>Io Lavoro was created for every foreigner</h2>
      <div>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea voluptatum distinctio in esse sed enim quisquam!
